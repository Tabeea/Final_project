...
def order(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'myapp/order.html',
                      {'multiple_form': multiple_form, 'pizzaform': filled_form, 'note': note,
...
def edit_order(request, pk):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            ...
            return render(request, 'myapp/edit_order.html', {'pizzaform': form, 'pizza': pizza, 'note': note})
    return render(request, 'myapp/edit_order.html', {'pizzaform': form, 'pizza': pizza})
...
def pizzas(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'myapp/pizzas.html', {'note': note, 'formset': formset})
    else:
        return render(request, 'myapp/pizzas.html', {'formset': formset})
